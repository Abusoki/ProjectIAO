            ...
            const generateNextWave = (mConf) => {
                ...
                return Array.from({ length: enemyCount }, (_, i) => {
                    ...
                    const stats = {
                        ...
                        // New Enemies (Level 11-30)
                        gargoyle: { maxHp: 120, ap: 20, def: 15, spd: 8 },
                        dark_knight: { maxHp: 300, ap: 35, def: 20, spd: 12 },
                        wolf_alpha: { maxHp: 150, ap: 30, def: 5, spd: 15 },
                        assassin_npc: { maxHp: 180, ap: 50, def: 5, spd: 20 },
                        hydra: { maxHp: 600, ap: 25, def: 10, spd: 8 },
                        cultist_leader: { maxHp: 200, ap: 40, def: 5, spd: 11 },
                        berserker: { maxHp: 400, ap: 60, def: 0, spd: 14 },
                        treant: { maxHp: 800, ap: 30, def: 25, spd: 4 },
                        chimera: { maxHp: 700, ap: 45, def: 12, spd: 13 },
                        iron_golem: { maxHp: 1000, ap: 40, def: 40, spd: 5 },
                        red_dragon: { maxHp: 1500, ap: 80, def: 30, spd: 12 },
                        elemental_mage: { maxHp: 350, ap: 70, def: 10, spd: 14 },
                        lich: { maxHp: 900, ap: 90, def: 15, spd: 10 },
                        shadow_phantom: { maxHp: 500, ap: 100, def: 5, spd: 25 },
                        void_lord: { maxHp: 2000, ap: 110, def: 35, spd: 11 },
                        phoenix: { maxHp: 1200, ap: 85, def: 20, spd: 16 },
                        behemoth: { maxHp: 2500, ap: 150, def: 50, spd: 6 },
                        titan: { maxHp: 3000, ap: 200, def: 60, spd: 5 },
                        fallen_god: { maxHp: 5000, ap: 250, def: 80, spd: 15 },
                        basilisk: { maxHp: 250, ap: 35, def: 15, spd: 9 },
                        // Dungeon
